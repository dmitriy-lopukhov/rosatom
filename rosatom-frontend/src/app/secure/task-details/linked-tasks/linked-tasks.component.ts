...
export class LinkedTasksComponent implements AfterViewInit, OnDestroy {
  ...
  getEmtpyMessage(): string {
    return `Связанных задач не найдено`;
  }
